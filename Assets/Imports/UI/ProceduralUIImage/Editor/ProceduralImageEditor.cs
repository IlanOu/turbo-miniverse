...
namespace UnityEditor.UI
{
    ...
    public class ProceduralImageEditor : ImageEditor
    {
        ...
        GUIContent spriteTypeContent = new GUIContent("Image typeCategory");
        ...
        protected void ModifierGUI()
        {
            ...
            {
                int index = EditorGUILayout.Popup(new GUIContent("Modifier typeCategory"), selectedId, con);
                if (selectedId != index)
                {
                    selectedId = index;
                    foreach (var item in targets)
                ...
                int index = EditorGUILayout.Popup(new GUIContent("Modifier typeCategory"), -1, con);
                if (index != -1)
                {
                    selectedId = index;
                    foreach (var item in targets)
