...
public class AudioPlayerUI : MonoBehaviour
{
    ...
    private AudioPlaylistManager playlistManager;
    ...
    [Header("Scrolling Title")] [SerializeField]
    ...
    private void UpdateTrackInfo(AudioTrack track, bool animate)
    {
        ...
        if (animate)
        {
            ...
            if (artistText != null)
            {
                ...
                artistFadeTween = artistText.DOFade(0f, trackChangeFadeDuration / 2f).SetEase(textFadeEase)
                    .OnComplete(() =>
                    {
    ...
    private IEnumerator DelayedTitleScrolling()
    {
        ...
        if (isScrollingNeeded)
        {
            ...
            titleScrollSequence.Append(titleText.rectTransform
                .DOAnchorPosX(-scrollDistance, scrollDistance / scrollSpeed).SetEase(Ease.Linear));
